export default function Visit() {
    return (
      <div>
       <section className="" data-aos="zoom-in-down" data-aos-duration="3000">
          ...
          <div className="max-w-full mx-auto rounded-lg overflow-hidden">
            <div className="border-t border-gray-200 px-6 py-4">
              ...
              <p className="mt-1 font-bold text-gray-600">
                <a href="tel:+123">Phone: +92 123456789</a>
              </p>
            ...
            <div className="border-t border-gray-200 px-6 py-4">
              <h3 className="text-lg font-medium text-gray-900">Timmings</h3>
              <p className="mt-1 text-gray-600"> Daily / 12PM - 5AM</p>
            </div>
          </div>
        </div>
